...
import { mainListItems } from "./dashinfo/listItems";
import Chart from "./dashinfo/Chart";
import Deposits from "./dashinfo/Deposits";
import Orders from "./dashinfo/Orders";
...
export default function Dashboard() {
  ...
  const handleOptionClick = (option) => {
    ...
    // Aquí puedes determinar qué componente debe mostrarse según la opción seleccionada
    if (option === "Dashboard") {
      setSelectedComponent(<Dashboard />);
    } else if (option === "Orders") {
      setSelectedComponent(<Notificaciones />);
    } else if (option === "Customers") {
      setSelectedComponent(<Clientes />);
    } else if (option === "Reports") {
      setSelectedComponent(<Reportes />);
    } else if (option === "Integrations") {
      setSelectedComponent(<Integraciones />);
    }
  };
